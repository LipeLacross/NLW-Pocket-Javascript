...
import { SummaryResponse } from '../http/get-summary'; // Use SummaryResponse diretamente
...
interface WeeklySummaryProps {
    summary: SummaryResponse; // Use SummaryResponse diretamente
}
                    ...
                    return (
                        <div className="space-y-4" key={date}>
                            ...
                            <ul className="space-y-3">
                                {goals.map((goal: { id: string; title: string; completedAt: string }) => {
